...
The GPU kernel is asserted against the CPU reference to 2.6e-4 over 2000 steps, with a
...
open http://127.0.0.1:8787/test/index.html      # 46 standing assertions
...
test/          46 assertions, several paired with sensitivity checks that must FAIL
